...
3. To reproduce the result, please change the related parameters in config.py according to [config.txt](https://github.com/marooncn/navbot/blob/master/materials/record/config.txt).
## Cite
